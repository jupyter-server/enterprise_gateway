...
.. admonition:: Use cases
    ...
    - *As a developer, I am currently using Golang and need to implement a KernelLauncher to allow the GO kernel I use to run remotely in my Kubernetes cluster.*
...
.. toctree::
   ...
   rest-api
..
   Developing new kernel launchers and kernelspecs for existing RMs!!!
