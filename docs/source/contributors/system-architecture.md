...
```{note}
Before you run a kernel associated with `SparkOperatorProcessProxy`, please ensure that spark operator is installed in aaan existing namespace of your Kubernetes cluster.
```
