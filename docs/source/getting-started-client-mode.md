...
[e.g. jupyter_enterprise_gateway_kernelspecs-2.0.0.b1.tar.gz](https://github.com/jupyter/enterprise_gateway/releases/download/v2.0.0.b1/jupyter_enterprise_gateway_kernelspecs-2.0.0.b1.tar.gz).
