...
[e.g. jupyter_enterprise_gateway_kernelspecs-2.1.0.dev2.tar.gz](https://github.com/jupyter/enterprise_gateway/releases/download/v2.1.0.dev2/jupyter_enterprise_gateway_kernelspecs-2.1.0.dev2.tar.gz).
