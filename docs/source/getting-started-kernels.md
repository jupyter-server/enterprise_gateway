...
+ [Hadoop YARN client mode](kernel-yarn-client-mode.html)
+ [Hadoop YARN cluster mode](kernel-yarn-cluster-mode.html)
+ [Kubernetes](kernel-kubernetes.html)
+ [Docker](kernel-docker.html)
+ [IBM Conductor](kernel-conductor.html)
